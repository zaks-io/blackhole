...
export default function Home() {
  ...
  return (
    <main className="bg-black text-white">
      ...
      <section
        ref={featuresRef}
        className="py-24 md:py-32 px-8 md:px-16 bg-[#050505]"
      >
      ...
      <section className="py-24 md:py-32 px-8 md:px-16 bg-black">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-neutral-400 leading-relaxed mb-12 max-w-2xl mx-auto">
            Real-time ray marching through curved spacetime using Schwarzschild
            geodesics. Light paths are computed per-pixel to accurately simulate
            gravitational lensing, the photon sphere, and relativistic Doppler
            effects.
          </p>
